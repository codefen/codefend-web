...
export const pageSoftwareMetaData = ({ title, description})=> ({
    title,
    description,
...
export const pageIndustriesMetaData = ({ title, description })=> ({
    title,
    description,
...
export const pageServicesMetaData = ({ title, description })=> ({
    title,
    description,
...
export const pageComplianceMetaData = ({ title, description })=> ({
    title,
    description,
...
export const pagePartnersMetaData = ({ title, description })=> ({
    title,
    description,
...
export const pageAboutUsMetaData = ({ title, description })=> ({
    title,
    description,
...
export const pageCalculatorMetaData = ({ title, description, locale })=> ({
    title,
    description,
    keywords: "Codefend Calculator, cybersecurity services, security research, infrastructure monitoring, team members, CEO information, company vision",
