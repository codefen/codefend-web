...
export default memo(function Plans({ t }) {
  return (
    <section className={css.prices}>
      <div className={css.content}>
        <div className={css.top}>
          ...
          >
            {t.description.map((texts, index) =>
              texts.bold ? (
                <strong key={index} style={{ color: texts.color }}>
                  {texts.text}
                </strong>
              ) : (
                <span key={index}>{texts.text}</span>
              )
            )}
          </motion.p>
        </div>
